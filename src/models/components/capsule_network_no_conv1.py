...
class CapsuleNetNoConv1(nn.Module):
    def __init__(
        self, 
        ...
        super(CapsuleNetNoConv1, self).__init__()
    
        self.classes_number = classes_number


        self.primary_capsules = CapsuleLayer(num_capsules=first_capsule_layer_dimension, num_route_nodes=-1, in_channels=1, out_channels=first_capusle_layer_convolution_layer_numbers,
                                             kernel_size=primary_caps_kernel_size, stride=primary_caps_stride)
        primary_caps_feature_map_dimension = floor( (input_image_dimension - primary_caps_kernel_size + primary_caps_stride ) / primary_caps_stride )
