...
class FER2013LitModule(LightningModule):
    """Example of LightningModule for FER2013 classification.
    ...
    def step(self, batch: Any):
        x, y = batch
        FER2013_CLASSES_NUMBER = 7
        labels = torch.eye(FER2013_CLASSES_NUMBER).to(DEVICE).index_select(dim=0, index=y)
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(root / "configs" / "model" / "fer2013.yaml")
